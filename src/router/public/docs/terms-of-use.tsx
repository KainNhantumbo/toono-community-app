        ...
        <article>
          <div className='mx-auto max-w-3xl p-6'>
            ...
            <p className='mb-4'>
              ...
              the following terms and conditions. Please review these Terms of Use
            ...
            <p className='mb-4'>
              We reserve the right to modify these Terms of Use at any time. Any changes
              will be effective immediately upon posting on our website. Your continued use
              of the site after any modifications indicates your acceptance of the new Terms
              of Use.
            </p>
            ...
            <p className='mb-4'>
              ...
              prohibited from using the site to engage in any activity that could harm
              others or that is illegal.
            </p>
            ...
            <p className='mb-4'>
              You agree not to use the site to upload, post, email, or otherwise transmit
              any content that is unlawful, harmful, or offensive. You also agree not to
              disrupt or interfere with the security or operation of the site.
            </p>
            ...
            <p className='mb-4'>
              ...
              kind. We do not warrant that the site will be available at all times or that
              it will be free from errors or viruses.
            </p>
            ...
            <p className='mb-4'>
              ...
              of the jurisdiction in which Toono Community operates, without regard to its
